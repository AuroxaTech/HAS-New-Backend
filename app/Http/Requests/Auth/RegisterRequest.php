...
class RegisterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'role' => 'required|string|max:50|in:admin,user,tenant,service_provider,landlord,visitor',
            ...
            'type' => 'required_if:role,landlord|max:255',
            'city' => 'required_if:role,landlord|max:255',
            'amount' => 'required_if:role,landlord',
            'address' => 'required_if:role,landlord|max:255',
            'lat' => 'required_if:role,landlord',
            'long' => 'required_if:role,landlord',
            'area_range' => 'required_if:role,landlord|max:255',
            'bedroom' => 'required_if:role,landlord|max:255',
            'bathroom' => 'required_if:role,landlord|max:255',
